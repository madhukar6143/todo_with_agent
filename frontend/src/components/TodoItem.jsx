    ...
    <li className="flex items-center gap-3 rounded-lg border border-gray-200 bg-white px-4 py-3 shadow-sm transition-shadow hover:shadow-md">
      ...
      <span
        className={`flex-1 text-sm ${
          todo.completed ? 'text-green-900 line-through opacity-50' : 'text-green-900'
        }`}
      >
        {todo.title}
      </span>
      <button
        ...
        className="rounded p-1 text-green-900 hover:bg-red-50 hover:text-red-500 transition-colors"
      >
