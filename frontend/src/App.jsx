    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 px-4 py-12">
      <div className="mx-auto w-full max-w-lg">
        <header className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-blue-900 tracking-tight">Todo</h1>
          <p className="mt-1 text-sm text-blue-700">Stay organised, get things done.</p>
        </header>
        ...
        <div className="rounded-2xl bg-white p-6 shadow-lg">
          ...
          {loading ? (
            <p className="py-8 text-center text-sm text-blue-900">Loading…</p>
          ) : (
            <>
